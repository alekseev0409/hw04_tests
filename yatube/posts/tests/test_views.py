...
class PostTests(TestCase):
    def get_info(self, post, test_form):
        post_text = post.text
        post_author = post.author.username
        group_post = post.group.title
        self.assertEqual(post_text, test_form['text'])
        self.assertEqual(post_author, test_form['author'])
        self.assertEqual(group_post, test_form['group'])
    ...
    def setUpClass(cls):
        ...
        cls.test_form = {'text': 'Тестовый пост',
                         'author': 'TestAuthor',
    ...
    def test_home_page_show_correct_context(self):
        ...
        self.get_info(response.context.get('page_obj')[0], self.test_form)
    ...
    def test_post_detail_pages_show_correct_context(self):
        ...
        response = self.authorized_client_author.get(url)
        self.get_info(response.context.get('post'), self.test_form)
