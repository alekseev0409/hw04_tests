...
class PostTests(TestCase):
    def get_info(self, post, post2):
        post_text = post.text
        post_author = post.author.username
        group_post = post.group.title
        self.assertEqual(post_text, post2.text)
        self.assertEqual(post_author, post2.author.username)
        self.assertEqual(group_post, post2.group.title)
